...
function updateCanvas() { 
    ...
    var random_sketch = Math.floor(Math.random() * quick_draw_data_set.length);
    console.log(random_sketch);
    document.getElementById('draw').innerHTML = "<p id='draw'>Sketch to be drawn = "+random_sketch+"</p>";
}
...
function draw() {
    if (drawn_sketch == sketch) {
        answer_holder = 'set';
        //score = score+1;
        document.getElementById('score').innerHTML = "<span id='score'>Score : "+score+"</span>";
    }
